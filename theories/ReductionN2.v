...
(** *** Context Injection: extract [ctx] and reducible from a [term] *)
...
Proof.
  ...
  - remember (S (measure_term t12 + measure_term t2)) as n.
    replace (S (S (measure_term t12) + measure_term t2)) with (S n) by auto.
    cbn. solveVI.
  - reflexivity.
  - remember c; induction c.
    + cbn. subst; exact IHred.
    + (* [c_appfun] *)
      rewrite Heqc0. step ctx_app. step measure_term. step step.
      destruct (ctx_app c t1) eqn:Ectx.
      * 
