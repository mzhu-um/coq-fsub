...
Function step (t : term) {measure measure_term} : option term :=
  match t with
  | app (abs _ t12) t2 =>
...
Proof.
  - intros; apply measure_term_le_ctx_inj with c'; auto.
  - intros; apply measure_term_le_ctx_inj with c'; auto.
  - intros; apply measure_term_le_ctx_inj with c'; auto.
  - intros; apply measure_term_le_ctx_inj with c'; auto.
  - intros; apply measure_term_le_ctx_inj with c'; auto.
...
Proof.
  intros. unfold step. unfold step_terminate. simpl. rewrite H.
